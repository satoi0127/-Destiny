...
<body>
        <div class="base">
            ...
            <img src="../image/Destiny_black.png" class="earth" width="170" height="170">
            </div>
            <button type="button" class="nextbutton" id="nextButton" onclick="location.href='G1-13login-input.php'"><div class="font" id="nextFont">Welcome to Destiny</div></button>
        </div>
